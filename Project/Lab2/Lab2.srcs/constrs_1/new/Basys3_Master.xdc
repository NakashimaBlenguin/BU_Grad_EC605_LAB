...
set_property PACKAGE_PIN U2 [get_ports {seven_enable[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {seven_enable[0]}]
set_property PACKAGE_PIN U4 [get_ports {seven_enable[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {seven_enable[1]}]
set_property PACKAGE_PIN V4 [get_ports {seven_enable[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {seven_enable[2]}]
set_property PACKAGE_PIN W4 [get_ports {seven_enable[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {seven_enable[3]}]
